...
#define OLED_DC_Clr() HAL_GPIO_WritePin(GPIOD,GPIO_PIN_1,GPIO_PIN_RESET)//DC
#define OLED_DC_Set() HAL_GPIO_WritePin(GPIOD,GPIO_PIN_1,GPIO_PIN_SET)
 		     
#define OLED_BLK_Clr()  HAL_GPIO_WritePin(GPIOD,GPIO_PIN_3,GPIO_PIN_RESET)//CS
#define OLED_BLK_Set()  HAL_GPIO_WritePin(GPIOD,GPIO_PIN_3,GPIO_PIN_SET)
